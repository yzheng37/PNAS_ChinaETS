...
use MatchPSM_2013.dta, clear

append using MatchPSM_2014.dta
...
merge m:1 id_unified using "MatchPSM.dta"
...
* Robustness Checks on Alternative Matching Methods (PSM)
foreach Y of varlist $dep_var_main {
	...
	outreg2 using "Robust_PSM.xls", excel keep(c.regu#c.post_implt c.region#c.post_annc) dec(3) /*
